...
class PortfolioPage extends StatelessWidget {
        ...
        Container(
          ...
          child: TextButton(
            ...
            child: Row(
             ...
             children: [Icon(Icons.add, size: 13, color: kLuckyBlue,
             ),
             Text('add portofoio', 
  ...
  Widget _portofolioCardList(String icon,String title, double percent, String amount, String time) {
    return Container(
          ...
          decoration: BoxDecoration(color: kWhite, borderRadius: BorderRadius.all(
            Radius.circular(15),
            ),
            boxShadow: [
              BoxShadow(
          ...
          child: Row(
            children: [
              Container(
                height: 55,
                width: 55,
                child: CircleAvatar(backgroundColor: kTropicalBlue,
